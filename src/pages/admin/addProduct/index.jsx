...
const AddProduct = () => {
  ...
  return (
    <div>
      <Form form={form} name="nest-messages" onFinish={addProduct} validateMessages={validateMessages} style={formStyle}>
        <Form.Item
          style={{ width: 350 }}
          name='name'
          label="Product name"
        ...
        <Form.Item
          ...
          <Select defaultValue="Select Supplier" style={{ width: 200 }} onChange={handleChange}>
        ...
        <Form.Item
          ...
          <Select defaultValue="Select Category" style={{ width: 200 }} onChange={handleChange}>
