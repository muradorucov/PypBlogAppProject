...
import Icon, {
	...
	TeamOutlined, FileProtectOutlined, GlobalOutlined,
	createFromIconfontCN
} from '@ant-design/icons';
import {Layout, Menu, Space} from 'antd';
import Logo from "../../assets/Code-Academy.jpg"
			...
			<Layout style={{minHeight: '100vh'}}>
				<Sider collapsible collapsed={collapsed} onCollapse={(value) => setCollapsed(value)}>
					<Space style={{margin: "14.8px 85px"}}>
						...
						<IconFont type="icon-javascript" style={{fontSize: '24px', color: 'white'}}/>
						<IconFont type="icon-java" style={{fontSize: '24px', color: 'white'}}/>
					</Space>
					<div className="logo"><Link to="/admin"><img src={Logo}
					                                             style={{width: "100%", marginBottom: 30}}/></Link></div>
				...
				<Layout className="site-layout">
					...
					<Footer style={{textAlign: 'center'}}> PYP Frontend ©2022 Created by Hajar </Footer>
				</Layout>
			</Layout>
		</>
	);
